...
const PORTFOLIO = {
  ...
  projects:[
    ...
    {name:'Social Media Research & Content Calendar',brand:'3rd Planet Global',platform:'Social media',type:'Internship highlight',source:'OWNER-CONFIRMED EXPERIENCE',objective:'Support social media management with competitor analysis, trend research and content calendar management.',role:'Social Media Intern',strategy:'Study competitor activity and emerging social trends to guide content planning.',approach:'Organize ideas and planned posts in a content calendar.',execution:'Assisted with social media management, competitor analysis, trend discovery and maintaining the content calendar.',results:'No campaign-specific results have been shared publicly.',learning:'Use competitor and trend findings to improve future content planning.',image:'',before:'',after:'',link:'https://www.linkedin.com/in/satyam-singh77/'},
  ...
  journey:[
    ...
    {company:'3rd Planet Global',role:'Social Media Intern',duration:'Previous · exact dates to confirm',responsibilities:'Supported social media management, competitor analysis, trend research and content calendar management.',campaigns:'Content calendar and social media planning; specific examples to add.',platforms:'Social media channels; exact platforms to confirm.',achievements:'Verified outcomes to add.'}
  ],
  education:[
  ...
  sources:[{label:'LinkedIn profile and authored posts — headline, work, education, skills and creative concepts',url:'https://www.linkedin.com/in/satyam-singh77/'},{label:'3rd Planet Global internship duties confirmed by Satyam',url:''},{label:'Teqfox work history supplied by portfolio owner',url:''}]
};
