...
export const pages = {
  ...
  '/impact': { label: 'Impact', title: 'Social Media Planning & Evidence | Satyam Singh', description: 'Explore Satyam Singh’s IDSSPL content calendar: 34 planned slots across static posts, carousels and reels, plus LinkedIn work and clearly separated performance metrics.' },
