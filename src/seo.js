...
export const pages = {
  ...
  '/work': { label: 'My work', title: 'Social Media Work & Concepts | Satyam Singh', description: 'Explore LinkedIn-sourced work highlights from IDSSPL Technologies and 3rd Planet Global, plus Satyam Singh’s Tropical Escape creative concept.' },
